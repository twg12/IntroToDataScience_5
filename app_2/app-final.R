...
for (i in 1: nrow(tmp_2)){
    tmp_2$score_num[i] = ifelse(tmp_2$weak[i] == 1, NA, tmp_2$score_num[i])}

SIG_1 = sp::merge(SIG_1, tmp_2)
...
pal = colorBin("YlGnBu", domain = SIG_1@data$score_num, bins = bins, na.color = "#FFFFFF")
